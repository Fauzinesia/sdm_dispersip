...
$get = mysqli_prepare($koneksi, "SELECT file_sk FROM kenaikan_pangkat WHERE kp_id=?");
...
$del = mysqli_prepare($koneksi, "DELETE FROM kenaikan_pangkat WHERE kp_id=?");
mysqli_stmt_bind_param($del, 'i', $id);
if (mysqli_stmt_execute($del)) {
  mysqli_stmt_close($del);
  header("Location: /sdm_dispersip/admin/kenaikan_pangkat/kenaikan_pangkat.php?msg=".urlencode('Data berhasil dihapus')."&type=success");
  exit();
}
mysqli_stmt_close($del);
header("Location: /sdm_dispersip/admin/kenaikan_pangkat/kenaikan_pangkat.php?msg=".urlencode('Gagal menghapus data')."&type=danger");
exit();
?>
